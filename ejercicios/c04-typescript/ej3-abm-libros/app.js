...
const precioProm = document.getElementById('stats');
const erroresForm = document.getElementById('errorForm');
const agregarLibroBoton = document.getElementById('agregarLibroBoton');
...
const disponibles = document.getElementById('mostrarDisponibles');
...
class LibroCl {
    ...
    disponible;
    genero;
    constructor(isbn, titulo, autor, precio, disponible, genero) {
        this.isbn = isbn;
        this.titulo = titulo;
        this.autor = autor;
        this.precio = precio;
